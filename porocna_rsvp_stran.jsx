...
.option{border:1px solid #ccc;padding:10px;border-radius:10px;margin:5px 0;cursor:pointer}
.selected{border:2px solid black}
input{width:100%;padding:8px;margin:5px 0 10px 0;border-radius:8px;border:1px solid #ccc}
.hidden{display:none}
</style>
</head>
<body>
...
if(selectedMenus.length>=limit){alert('Lahko izberete samo '+limit+' menijev');return;}
...
if(selectedMenus.length!=adults){alert('Izberite ustrezno število menijev');return;}
